ComputeISgeneral <- function(IS2 = FALSE, c, dur, gradient) {
  ...
  #   dur: 
  #   gradient:
  #   IS2: TRUE if output the information matrix for (w,a.vec,b.vec) and the scaled gradiant matrix
  #
  # Returns:
  #   list(i.mat, s.vec)
  ...
  A <- matrix(0, nrow = num.coeff, ncol = 1)
